      ...
      <div className="relative w-full max-w-255 bg-white rounded-[28px] shadow-2xl overflow-hidden p-6 sm:p-8 flex flex-col gap-6 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 w-full aspect-4/3 lg:h-85 rounded-2xl overflow-hidden bg-gray-100 border border-gray-100">
            <img 
              src="../../src/assets/project_img/seva2.png" 
              alt="Aahar Seva Impact Initiative" 
              className="w-full h-full object-cover object-center"
              onError={(e) => {
                e.target.src = "../../src/assets/project_img/seva2.png";
              }}
            />
          </div>
          ...
          <div className="lg:col-span-7 flex flex-col justify-start relative pr-8">
            ...
            <p className="text-gray-600 text-[12px] font-semibold leading-relaxed tracking-normal max-w-xl mb-6">
              Project Seva is dedicated to supporting underprivileged communities through food distribution, clothing drives, and essential aid programs. The initiative ensures that vulnerable individuals and families receive basic necessities with dignity and care.
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-2 w-full border-t border-dashed border-gray-100">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div className="flex flex-col">
                  <span className="text-[14px] font-black text-gray-950 tracking-tight leading-none">50,000++</span>
                  <span className="text-[9.5px] font-bold text-gray-400 tracking-tight mt-1">Meals Served</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div className="flex flex-col">
                  <span className="text-[14px] font-black text-gray-950 tracking-tight leading-none">28+</span>
                  <span className="text-[9.5px] font-bold text-gray-400 tracking-tight mt-1">communities</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div className="flex flex-col">
                  <span className="text-[14px] font-black text-gray-950 tracking-tight leading-none">200+</span>
                  <span className="text-[9.5px] font-bold text-gray-400 tracking-tight mt-1">volunteers</span>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch mt-2">
          ...
          <div className="flex flex-col justify-start">
            ...
            <p className="text-gray-500 text-[11.5px] font-semibold leading-relaxed tracking-normal mb-5">
              Seva focuses on reducing hunger and hardship through regular distribution drives. Volunteers work together to provide meals, clothing, and emergency support to those facing financial and social challenges.
            </p>
          ...
          <div className="bg-[#FDF2F2]/40 border border-red-50/50 rounded-2xl p-5 flex flex-col justify-between gap-4">
            <div>
              ...
              <p className="text-gray-500 text-[11.5px] font-semibold leading-relaxed tracking-normal">
                More than 50,000 meals and clothing essentials have been distributed through Project Seva, helping thousands of beneficiaries across multiple communities.
              </p>
            </div>
            ...
            <div className="grid grid-cols-4 gap-2 w-full mt-1">
              {[
                "../../src/assets/project_img/s1.png",
                "../../src/assets/project_img/s2.png",
                "../../src/assets/project_img/s3.png",
                "../../src/assets/project_img/s4.png"
              ].map((imgUrl, i) => (
        ...
        <div className="w-full border-t border-gray-100 pt-5 flex flex-col sm:flex-row items-center justify-between gap-5 mt-2">
          ...
          <div className="flex flex-col gap-1 text-center sm:text-left max-w-md">
            ...
            <span className="text-gray-400 text-[10px] font-bold tracking-wider sm:pl-3">
              — InAmigos Foundation's Commitment to Service and Compassion
            </span>
          </div>

          <div className="flex items-center gap-3 w-full sm:w-auto shrink-0">
            <button onClick={() => shareProject({ id: 'seva', title: 'Seva', description: 'Project Seva is dedicated to supporting underprivileged communities through food distribution, clothing drives, and essential aid programs. The initiative ensures that vulnerable individuals and families receive basic necessities with dignity and care.', metric: '50,000++ Meals Served', img: sevaCover })} className="flex-1 sm:flex-none border border-gray-300 hover:bg-gray-50 text-gray-800 font-extrabold text-[11.5px] tracking-wide px-5 py-2.5 rounded-xl flex items-center justify-center gap-2 transition-colors duration-150 cursor-pointer">
