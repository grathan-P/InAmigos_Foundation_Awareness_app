        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-start relative pr-8">
            ...
            <p className="text-gray-600 text-[12px] font-semibold leading-relaxed tracking-normal max-w-xl mb-6">
              Project Jeev is dedicated to animal welfare through feeding drives, rescue efforts, shelter support, and compassionate care for stray and abandoned animals.
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-2 w-full border-t border-dashed border-gray-100">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div className="flex flex-col">
                  <span className="text-[14px] font-black text-gray-950 tracking-tight leading-none">50+</span>
                  <span className="text-[9.5px] font-bold text-gray-400 tracking-tight mt-1">Animals Fed Daily</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div className="flex flex-col">
                  <span className="text-[14px] font-black text-gray-950 tracking-tight leading-none">500+</span>
                  <span className="text-[9.5px] font-bold text-gray-400 tracking-tight mt-1">Rescue Activities</span>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch mt-2">
          ...
          <div className="flex flex-col justify-start">
            ...
            <p className="text-gray-500 text-[11.5px] font-semibold leading-relaxed tracking-normal mb-5">
              The project serves as a source of hope for stray animals by providing food, shelter, rescue assistance, and emotional care. Volunteers actively work to improve the living conditions of animals in need.
            </p>
          ...
          <div className="bg-[#FDF2F2]/40 border border-red-50/50 rounded-2xl p-5 flex flex-col justify-between gap-4">
            <div>
              ...
              <p className="text-gray-500 text-[11.5px] font-semibold leading-relaxed tracking-normal">
                Project Jeev supports dozens of stray animals daily and continues expanding its network of volunteers committed to animal welfare.
              </p>
            </div>
        ...
        <div className="w-full border-t border-gray-100 pt-5 flex flex-col sm:flex-row items-center justify-between gap-5 mt-2">
          ...
          <div className="flex flex-col gap-1 text-center sm:text-left max-w-md">
            ...
            <span className="text-gray-400 text-[10px] font-bold tracking-wider sm:pl-3">
              — InAmigos Foundation's Commitment to Compassion
            </span>
          </div>

          <div className="flex items-center gap-3 w-full sm:w-auto shrink-0">
            <button onClick={() => shareProject({ id: 'jeev', title: 'Jeev', description: 'Project Jeev is dedicated to animal welfare through feeding drives, rescue efforts, shelter support, and compassionate care for stray and abandoned animals.', metric: '50+ Animals Fed Daily', img: jeevCover })} className="flex-1 sm:flex-none border border-gray-300 hover:bg-gray-50 text-gray-800 font-extrabold text-[11.5px] tracking-wide px-5 py-2.5 rounded-xl flex items-center justify-center gap-2 transition-colors duration-150 cursor-pointer">
